...
- [625. 最小因式分解](https://leetcode.cn/problems/minimum-factorization/description/)
- [2847. 给定数字乘积的最小数字](https://leetcode.cn/problems/smallest-number-with-given-digit-product/description/)
